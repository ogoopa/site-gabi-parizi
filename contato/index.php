...
<div id="contact" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom">
    ...
    <div class="w3-container">
      ...
      <form action="processa.php" method="POST" target="_blank">
        <p><input class="w3-input w3-padding-16 w3-border" type="text"  name="nome" id="nome"></p>
        <p><input class="w3-input w3-padding-16 w3-border" type="email"  name="email_cliente" id="email_cliente"></p>
        <p><input class="w3-input w3-padding-16 w3-border" type="text" name="mensagem" id="mensagem"></p>
